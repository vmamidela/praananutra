...
<div id="header_wrapper">
  <div id="inner_header_wrapper">
    ...
    <header id="header" role="banner">
      <?php if (theme_get_setting('social_links', 'praananutra_theme')): ?>
      <div class="social-icons">
       <ul>
        ...
        <li><a href="http://www.facebook.com/<?php echo theme_get_setting('facebook_username', 'praananutra_theme'); ?>" target="_blank" rel="me"><img src="<?php print base_path() . drupal_get_path('theme', 'business_responsive_theme') . '/images/facebook.png'; ?>" alt="Facebook"/></a></li>
        <li><a href="http://www.twitter.com/<?php echo theme_get_setting('twitter_username', 'praananutra_theme'); ?>" target="_blank" rel="me"><img src="<?php print base_path() . drupal_get_path('theme', 'business_responsive_theme') . '/images/twitter.png'; ?>" alt="Twitter"/></a></li>
       </ul>
      </div>
    <?php endif; ?>
  ...
  <div id="container">
    ...
    <div id="content">
      <?php if (theme_get_setting('breadcrumbs', 'praananutra_theme')): ?><div id="breadcrumbs"><?php if ($breadcrumb): print $breadcrumb; endif;?></div><?php endif; ?>
